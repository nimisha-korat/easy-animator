...
namespace EasyAnimator.Editor
{
    ...
    [CustomEditor(typeof(EasyAnimatorComponent), true), CanEditMultipleObjects]
    public class EasyAnimatorComponentEditor : BaseEasyAnimatorComponentEditor
    {
        ...
        private void DoAnimatorGUI(SerializedProperty property, GUIContent label)
        {
            ...
            if (!hasAnimator)
            {
                ...
                if (EasyAnimatorGUI.TryUseClickEventInLastRect())
                {
                    ...
                    {
                        var target = (IEasyAnimatorComponent)targetProperty.serializedObject.targetObject;
            ...
            else if (property.objectReferenceValue is Animator animator)
            {
                ...
                if (EasyAnimatorPlayable.HasChangedToOrFromAnimatePhysics(initialUpdateMode, updateMode))
                {
                    EditorGUILayout.HelpBox(
        ...
        private void DoActionOnDisableGUI(SerializedProperty property, GUIContent label)
        {
            ...
            if (property.enumValueIndex == (int)EasyAnimatorComponent.DisableAction.Reset)
            {
