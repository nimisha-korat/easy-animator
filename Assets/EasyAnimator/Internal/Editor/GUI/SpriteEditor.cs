...
namespace EasyAnimator.Editor
{
    ...
    public class SpriteEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            GUILayout.Space(EasyAnimatorGUI.StandardSpacing);
        ...
        private void DoNameGUI()
        {
            ...
            if (GUILayout.Button("Rename Tool", EditorStyles.miniButton, EasyAnimatorGUI.DontExpandWidth))
                EasyAnimatorToolsWindow.Open(typeof(EasyAnimatorToolsWindow.RenameSprites));
        ...
        private sealed class NormalizedPixelField
        {
            ...
            {
                var height = (EasyAnimatorGUI.LineHeight + EasyAnimatorGUI.StandardSpacing) * (fields.Length + 1);
