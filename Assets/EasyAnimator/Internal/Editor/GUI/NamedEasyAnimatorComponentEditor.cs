...
namespace EasyAnimator.Editor
{
    ...
    [CustomEditor(typeof(NamedEasyAnimatorComponent), true), CanEditMultipleObjects]
    public class NamedEasyAnimatorComponentEditor : EasyAnimatorComponentEditor
    {
        ...
        private void DoDefaultAnimationField(SerializedProperty playAutomatically)
        {
            ...
            var playAutomaticallyWidth = EditorGUIUtility.labelWidth + EasyAnimatorGUI.ToggleWidth;
            var playAutomaticallyArea = EasyAnimatorGUI.StealFromLeft(ref area, playAutomaticallyWidth);
        ...
        {
            GUILayout.Space(EasyAnimatorGUI.StandardSpacing - 1);
            ...
            if (_Animations == null)
            {
                _Animations = new ReorderableList(property.serializedObject, property.Copy())
                {
                    ...
                    elementHeight = EasyAnimatorGUI.LineHeight,
            ...
            EasyAnimatorGUI.HandleDragAndDropAnimations(GUILayoutUtility.GetLastRect(), (clip) =>
            {
