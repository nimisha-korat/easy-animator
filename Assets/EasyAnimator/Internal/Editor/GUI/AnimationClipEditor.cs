...
namespace EasyAnimator.Editor
{
    ...
    public class AnimationClipEditor : UnityEditor.Editor
    {
        ...
        private void InitializeSpritePreview(UnityEditor.Editor editor, AnimationClip clip)
        {
            ...
            var field = editor.GetType().GetField("m_AvatarPreview", EasyAnimatorEditorUtilities.InstanceBindings);
            if (field == null)
                return;
            ...
            var previewObject = previewType.GetProperty("PreviewObject", EasyAnimatorEditorUtilities.InstanceBindings);
            ...
            var method = previewType.GetMethod("SetPreview",
                EasyAnimatorEditorUtilities.InstanceBindings, null,
        ...
        private static void DrawSpriteFrames(AnimationClip clip)
        {
            ...
            for (int i = 0; i < keyframes.Length; i++)
            {
                ...
                if (sprite != null)
                {
                    ...
                    var area = GUILayoutUtility.GetRect(0, EasyAnimatorGUI.LineHeight * 4);
                    ...
                    var offset = area.width + EasyAnimatorGUI.StandardSpacing;
                    area.x += offset;
