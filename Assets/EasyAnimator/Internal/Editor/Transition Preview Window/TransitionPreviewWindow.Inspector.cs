...
namespace EasyAnimator.Editor
{
    ...
    partial class TransitionPreviewWindow
    {
        ...
        internal sealed class Inspector : UnityEditor.Editor
        {
            ...
            {
                GUILayout.Space(EasyAnimatorGUI.StandardSpacing * 2);
            ...
            private void DoPreviewInspectorGUI()
            {
                ...
                var EasyAnimator = Target._Scene.EasyAnimator;
                if (EasyAnimator != null)
                {
                    PlayableDrawer.DoGUI(EasyAnimator.Component);
            ...
            private void DoTransitionPropertyGUI()
            {
                ...
                using (new EditorGUI.DisabledScope(true))
                {
                    ...
                    GUILayout.BeginHorizontal();
                    {
                        ...
                        {
                            if (GUILayout.Button(label, EditorStyles.miniButton, EasyAnimatorGUI.DontExpandWidth))
                            {
                                Target.Close();
                                GUIUtility.ExitGUI();
                            }
