...
namespace EasyAnimator.Editor
{
    ...
    partial class TransitionPreviewWindow
    {
        ...
        [Serializable]
        internal sealed class Settings : EasyAnimatorSettings.Group
        {
             

            private static Settings Instance => EasyAnimatorSettings.TransitionPreviewWindow;

             

            public static void DoInspectorGUI()
            {
                EasyAnimatorSettings.SerializedObject.Update();
                ...
                EasyAnimatorSettings.SerializedObject.ApplyModifiedProperties();
            }
            ...
            private static void DoModelsGUI()
            {
                ...
                EasyAnimatorGUI.HandleDragAndDrop<GameObject>(area,
                    (gameObject) =>
                    {
                        return
                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    if (GUILayout.Button("x", EasyAnimatorGUI.MiniButton))
                    {
            ...
            public static List<GameObject> Models
            {
                get
                {
                    ...
                    EasyAnimatorEditorUtilities.RemoveMissingAndDuplicates(ref instance._Models);
            ...
            public static GameObject DefaultHumanoid
            {
                get
                {
                    ...
                    {
                        // Try to load EasyAnimator's DefaultHumanoid.
